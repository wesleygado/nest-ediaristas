  ...
  app.engine(
    ...
    exphbs.engine({
      ...
      helpers: {
        ...
        menuCadastroServiceOpen: function () {
          const url: string = exp.locals.expreq['originalUrl'];
          if (url === '/services/create' || url === '/services/index') {
